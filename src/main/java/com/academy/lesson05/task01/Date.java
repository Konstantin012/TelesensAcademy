...
import com.academy.lesson08.homeWork.exeptions.IllegalDateException;
...
public class Date extends Months {
    ...
    public boolean checkData(int day, int month, int year) throws IllegalDateException {
...
//            System.out.println("Введенная дата: " + dateTemp);
    ...
    public void checkForCheckData(int day, int month, int year) {
        try {
            ...
            System.out.println(new IllegalDateException().getMessage());
        }
    }
